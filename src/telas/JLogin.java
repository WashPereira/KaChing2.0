...
public class JLogin extends JFrame {
	...
	public JLogin() {
		...
		lblKaching.setIcon(new ImageIcon(JLogin.class
				.getResource("/img/Kaching 02.png")));
		...
		lblEntar.addMouseListener(new MouseAdapter() {
			@Override
		...
		lblEntar.setIcon(new ImageIcon(JLogin.class
				.getResource("/img/arrow242.png")));
		...
		lblCadastrar.setIcon(new ImageIcon(JLogin.class
		...
		lblEsqueciMinhaSenha.setIcon(new ImageIcon(JLogin.class
				.getResource("/img/question.png")));
