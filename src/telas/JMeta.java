...
public class JMeta extends JFrame {
	...
	public JMeta() {
		...
		descricao.setBackground(SystemColor.control);
		...
		comboboxmetas.setBackground(Color.WHITE);
		comboboxmetas.setModel(new DefaultComboBoxModel(new String[] { " ",
				"Caixa/Poupar", "Despesa", "Receita" }));
		...
		panel_2.add(label_4);
		label_4.setIcon(new ImageIcon(JMeta.class
		...
		panel_2.add(label_5);
		label_5.setIcon(new ImageIcon(JMeta.class
		...
		label_7.setIcon(new ImageIcon(JMeta.class
				.getResource("/img/editar3.png")));
		...
		label_9.setIcon(new ImageIcon(JMeta.class
				.getResource("/img/floppy1.png")));
		...
		table_1.setModel(new DefaultTableModel(new Object[][] {
				...
				{ null, null, null, null, null },
				{ null, null, null, null, null },
				{ null, null, null, null, null }, }, new String[] { "N\u00BA",
				"Nome - Descri\u00E7\u00E3o", "Status", "Valor", "Data" }));
		...
		label_6.setIcon(new ImageIcon(JMeta.class
		...
		label_8.setIcon(new ImageIcon(JMeta.class
				.getResource("/img/leftarrow.png")));
